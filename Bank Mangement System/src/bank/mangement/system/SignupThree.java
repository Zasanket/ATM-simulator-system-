...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        add(card);
         ...
         JLabel number = new JLabel("XXXX-XXXX-XXXX-4320");
        number.setFont(new Font("Raleway",Font.BOLD,22));
        number.setBounds(330,220,300,30);
        add(number);
        
         JLabel cardDetails = new JLabel("This is 16 digit Card Number");
        ...
        add(c6);
         ...
         c7= new JCheckBox("I hereby declare that the above enter details are the correct ");
